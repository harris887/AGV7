...
LOAD_MOD_BUS_DATA:   
    ...
    //默认值，20160608
    //pMOD_BUS_Reg->AUTO_FOLLOW_SPEED=30;//30%巡线速度
    MOD_BUS_Reg.M_CONTROL_MODE = DEFAULT_MOD_BUS_Reg.M_CONTROL_MODE;
    MOD_BUS_Reg.FOLLOW_LOOP_TIME_IN_MS = DEFAULT_MOD_BUS_Reg.FOLLOW_LOOP_TIME_IN_MS;
    MOD_BUS_REG_Backup();
}
